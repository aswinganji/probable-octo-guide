...
try:
    ...
    police_car_spawn_point = (world.get_map().get_spawn_points()[3])  # set spawn point here
    police_car = world.spawn_actor(police_car_blueprint, police_car_spawn_point)
    police_car.apply_control(carla.VehicleControl(throttle=1))
    time.sleep(4)
    police_car.apply_control(carla.VehicleControl(throttle=0.2))
